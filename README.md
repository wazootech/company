...
(0-5 people). Following the **skills.sh** paradigm, this module can be used by
anyone to advise their decisions and coordinate LLM outputs.

We use **protocol-driven generation** to ensure consistency and quality.
...
operational protocols. The **Communications Manager** is particularly useful for
transforming technical updates into public-facing docs and socials:
...
npx skills add wazootech/company/communications-manager
