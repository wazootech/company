---
name: mega-plan-audit
description: Maximum Rigor Project Auditor. Use this skill to evaluate project scope and technical plans with extreme prejudice. It offers three modes of review: Expansion (build the cathedral), Hold (rigorous execution), and Reduction (ruthless MVP focus).
---
